...
PINCTRL_FUNC(CIS_HSYNC, 0, FUNC0);
PINCTRL_FUNC(GPIO17, 0, FUNC1);
PINCTRL_FUNC(CIS_VSYNC, 1, FUNC0);
PINCTRL_FUNC(GPIO18, 1, FUNC1);
PINCTRL_FUNC(CIS_PCLK, 2, FUNC0);
PINCTRL_FUNC(GPIO19, 2, FUNC1);
PINCTRL_FUNC(CIS_D_0, 3, FUNC0);
PINCTRL_FUNC(GPIO20, 3, FUNC1);
PINCTRL_FUNC(CIS_D_1, 4, FUNC0);
PINCTRL_FUNC(GPIO21, 4, FUNC1);
PINCTRL_FUNC(CIS_D_2, 5, FUNC0);
PINCTRL_FUNC(GPIO22, 5, FUNC1);
PINCTRL_FUNC(CIS_D_3, 6, FUNC0);
PINCTRL_FUNC(GPIO23, 6, FUNC1);
PINCTRL_FUNC(CIS_D_4, 7, FUNC0);
PINCTRL_FUNC(GPIO24, 7, FUNC1);
PINCTRL_FUNC(CIS_D_5, 8, FUNC0);
PINCTRL_FUNC(GPIO25, 8, FUNC1);
PINCTRL_FUNC(CIS_D_6, 9, FUNC0);
PINCTRL_FUNC(GPIO26, 9, FUNC1);
PINCTRL_FUNC(CIS_D_7, 10, FUNC0);
PINCTRL_FUNC(GPIO27, 10, FUNC1);
PINCTRL_FUNC(CIS_D_8, 11, FUNC0);
PINCTRL_FUNC(GPIO28, 11, FUNC1);
PINCTRL_FUNC(CIS_D_9, 12, FUNC0);
PINCTRL_FUNC(GPIO29, 12, FUNC1);
PINCTRL_FUNC(CIS_D_10, 13, FUNC0);
PINCTRL_FUNC(GPIO30, 13, FUNC1);
PINCTRL_FUNC(CIS_D_11, 14, FUNC0);
PINCTRL_FUNC(GPIO31, 14, FUNC1);
PINCTRL_FUNC(MAC_RMII_CLK, 15, FUNC0);
PINCTRL_FUNC(SD1_CLK, 15, FUNC1);
PINCTRL_FUNC(MAC_REF_CLK, 16, FUNC0);
PINCTRL_FUNC(MAC_MDC, 17, FUNC0);
PINCTRL_FUNC(GPIO34, 17, FUNC1);
PINCTRL_FUNC(UART2_RX, 17, FUNC2);
PINCTRL_FUNC(PWM5, 17, FUNC3);
PINCTRL_FUNC(MAC_MDIO, 18, FUNC0);
PINCTRL_FUNC(GPIO35, 18, FUNC1);
PINCTRL_FUNC(UART2_TX, 18, FUNC2);
PINCTRL_FUNC(PWM6, 18, FUNC3);
PINCTRL_FUNC(MAC_COL, 19, FUNC0);
PINCTRL_FUNC(GPIO32, 19, FUNC1);
PINCTRL_FUNC(UART1_TX, 19, FUNC2);
PINCTRL_FUNC(PWM0, 19, FUNC3);
PINCTRL_FUNC(MAC_CRS, 20, FUNC0);
PINCTRL_FUNC(GPIO33, 20, FUNC1);
PINCTRL_FUNC(UART1_RX, 20, FUNC2);
PINCTRL_FUNC(PWM4, 20, FUNC3);
PINCTRL_FUNC(MAC_RXCK, 21, FUNC0);
PINCTRL_FUNC(GPIO36, 21, FUNC1);
PINCTRL_FUNC(AC_MCLK, 21, FUNC2);
PINCTRL_FUNC(PWM7, 21, FUNC3);
...
PINCTRL_FUNC(MAC_RXD_2, 24, FUNC0);
PINCTRL_FUNC(GPIO37, 24, FUNC1);
PINCTRL_FUNC(MAC_RXD_3, 25, FUNC0);
PINCTRL_FUNC(GPIO38, 25, FUNC1);
PINCTRL_FUNC(MAC_RXDV, 26, FUNC0);
PINCTRL_FUNC(SD1_CD, 26, FUNC1);
PINCTRL_FUNC(UART2_TX, 26, FUNC2);
PINCTRL_FUNC(GPIO39, 26, FUNC3);
PINCTRL_FUNC(MAC_TXCK, 27, FUNC0);
PINCTRL_FUNC(GPIO41, 27, FUNC1);
...
PINCTRL_FUNC(MAC_TXD_2, 30, FUNC0);
PINCTRL_FUNC(GPIO42, 30, FUNC1);
PINCTRL_FUNC(MAC_TXD_3, 31, FUNC0);
PINCTRL_FUNC(GPIO43, 31, FUNC1);
...
PINCTRL_FUNC(MAC_TXER, 34, FUNC0);
PINCTRL_FUNC(GPIO45, 34, FUNC1);
...
PINCTRL_FUNC(ARC_JTAG_TMS, 40, FUNC0);
PINCTRL_FUNC(SSI1_TXD, 40, FUNC1);
PINCTRL_FUNC(PAE_JTAG_TMS, 40, FUNC2);
PINCTRL_FUNC(GPIO5, 40, FUNC3);
PINCTRL_FUNC(ARC_JTAG_TCK, 41, FUNC0);
PINCTRL_FUNC(SSI1_RXD, 41, FUNC1);
PINCTRL_FUNC(PAE_JTAG_TCK, 41, FUNC2);
PINCTRL_FUNC(GPIO6, 41, FUNC3);
PINCTRL_FUNC(ARC_JTAG_TDI, 42, FUNC0);
PINCTRL_FUNC(SSI1_CLK, 42, FUNC1);
PINCTRL_FUNC(PAE_JTAG_TDI, 42, FUNC2);
PINCTRL_FUNC(GPIO7, 42, FUNC3);
PINCTRL_FUNC(ARC_JTAG_TDO, 43, FUNC0);
PINCTRL_FUNC(SSI1_CSN_0, 43, FUNC1);
PINCTRL_FUNC(PAE_JTAG_TDO, 43, FUNC2);
PINCTRL_FUNC(GPIO8, 43, FUNC3);
PINCTRL_FUNC(ARC_JTAG_TRSTN, 44, FUNC0);
PINCTRL_FUNC(SSI1_CSN_1, 44, FUNC1);
PINCTRL_FUNC(PAE_JTAG_TRSTN, 44, FUNC2);
PINCTRL_FUNC(GPIO9, 44, FUNC3);
PINCTRL_FUNC(PWM1, 44, FUNC4);
PINCTRL_FUNC(UART2_TX, 45, FUNC0);
PINCTRL_FUNC(PWM2, 45, FUNC1);
PINCTRL_FUNC(GPIO10, 45, FUNC2);
PINCTRL_FUNC(UART2_RX, 46, FUNC0);
PINCTRL_FUNC(PWM3, 46, FUNC1);
PINCTRL_FUNC(GPIO11, 46, FUNC2);
...
PINCTRL_FUNC(I2C1_SCL, 54, FUNC0);
PINCTRL_FUNC(AD_I2S_WS, 54, FUNC1);
PINCTRL_FUNC(I2S_WS, 54, FUNC2);
PINCTRL_FUNC(GPIO61, 54, FUNC3);
PINCTRL_FUNC(I2C1_SDA, 55, FUNC0);
PINCTRL_FUNC(AD_I2S_CLK, 55, FUNC1);
PINCTRL_FUNC(I2S_CLK, 55, FUNC2);
PINCTRL_FUNC(GPIO60, 55, FUNC3);
...
PINCTRL_FUNC(SD1_WP, 70, FUNC0);
PINCTRL_FUNC(GPIO65, 70, FUNC1);
PINCTRL_FUNC(DA_I2S_WS, 70, FUNC2);
...
PINCTRL_FUNC(SD1_DATA_1, 74, FUNC0);
PINCTRL_FUNC(GPIO57, 74, FUNC1);
PINCTRL_FUNC(SD1_DATA_2, 75, FUNC0);
PINCTRL_FUNC(DA_I2S_DO, 75, FUNC1);
PINCTRL_FUNC(I2S_DO, 75, FUNC2);
PINCTRL_FUNC(GPIO58, 75, FUNC3);
PINCTRL_FUNC(FTO_EFUSE_AVDD_SW, 75, FUNC4);
PINCTRL_FUNC(SD1_DATA_3, 76, FUNC0);
PINCTRL_FUNC(AD_I2S_DI, 76, FUNC1);
PINCTRL_FUNC(I2S_DI, 76, FUNC2);
PINCTRL_FUNC(GPIO59, 76, FUNC3);

PINCTRL_MUX(AC_MCLK, 0, &PAD21_AC_MCLK, &PAD59_AC_MCLK);

PINCTRL_MUX(ACI2S_AD_CLK, 0, &PAD55_AD_I2S_CLK, &PAD61_AD_I2S_CLK);
PINCTRL_MUX(ACI2S_AD_DI, 0, &PAD68_AD_I2S_DI, &PAD76_AD_I2S_DI);
PINCTRL_MUX(ACI2S_AD_WS, 0, &PAD54_AD_I2S_WS, &PAD62_AD_I2S_WS);
PINCTRL_MUX(ACI2S_DA_CLK, 0, &PAD23_DA_I2S_CLK, &PAD69_DA_I2S_CLK);
PINCTRL_MUX(ACI2S_DA_DO, 0, &PAD67_DA_I2S_DO, &PAD75_DA_I2S_DO);
PINCTRL_MUX(ACI2S_DA_WS, 0, &PAD39_DA_I2S_WS, &PAD70_DA_I2S_WS);

PINCTRL_MUX(DWI2S_CLK, 0, &PAD55_I2S_CLK, &PAD61_I2S_CLK);
PINCTRL_MUX(DWI2S_DI, 0, &PAD68_I2S_DI, &PAD76_I2S_DI);
PINCTRL_MUX(DWI2S_DO, 0, &PAD67_I2S_DO, &PAD75_I2S_DO);
PINCTRL_MUX(DWI2S_WS, 0, &PAD54_I2S_WS, &PAD62_I2S_WS);

PINCTRL_MUX(ARCJTAG_TCK, 0, &PAD41_ARC_JTAG_TCK, &PAD65_ARC_JTAG_TCK);
PINCTRL_MUX(ARCJTAG_TDI, 0, &PAD42_ARC_JTAG_TDI, &PAD66_ARC_JTAG_TDI);
PINCTRL_MUX(ARCJTAG_TDO, 0, &PAD43_ARC_JTAG_TDO, &PAD68_ARC_JTAG_TDO);
PINCTRL_MUX(ARCJTAG_TMS, 0, &PAD40_ARC_JTAG_TMS, &PAD64_ARC_JTAG_TMS);
PINCTRL_MUX(ARCJTAG_TRSTN, 0, &PAD44_ARC_JTAG_TRSTN, &PAD63_ARC_JTAG_TRSTN);
...
PINCTRL_MUX(PAEJTAG_TCK, 0, &PAD41_PAE_JTAG_TCK, &PAD65_PAE_JTAG_TCK);
PINCTRL_MUX(PAEJTAG_TDI, 0, &PAD42_PAE_JTAG_TDI, &PAD66_PAE_JTAG_TDI);
PINCTRL_MUX(PAEJTAG_TDO, 0, &PAD43_PAE_JTAG_TDO, &PAD68_PAE_JTAG_TDO);
PINCTRL_MUX(PAEJTAG_TMS, 0, &PAD40_PAE_JTAG_TMS, &PAD64_PAE_JTAG_TMS);
PINCTRL_MUX(PAEJTAG_TRSTN, 0, &PAD44_PAE_JTAG_TRSTN, &PAD63_PAE_JTAG_TRSTN);
...
PINCTRL_MUX(I2C1_SCL, 0, &PAD51_I2C1_SCL, &PAD54_I2C1_SCL);
PINCTRL_MUX(I2C1_SDA, 0, &PAD50_I2C1_SDA, &PAD55_I2C1_SDA);

PINCTRL_MUX(MAC_REF_CLK, 0, &PAD16_MAC_REF_CLK);
PINCTRL_MUX(MAC_RMII_CLK, 0, &PAD15_MAC_RMII_CLK);
PINCTRL_MUX(MAC_COL, 0, &PAD19_MAC_COL);
PINCTRL_MUX(MAC_CRS, 0, &PAD20_MAC_CRS);
PINCTRL_MUX(MAC_MDC, 0, &PAD17_MAC_MDC, &PAD38_MAC_MDC);
PINCTRL_MUX(MAC_MDIO, 0, &PAD18_MAC_MDIO, &PAD39_MAC_MDIO);
PINCTRL_MUX(MAC_RXCK, 0, &PAD21_MAC_RXCK);
PINCTRL_MUX(MAC_RXD_0, 0, &PAD22_MAC_RXD_0);
PINCTRL_MUX(MAC_RXD_1, 0, &PAD23_MAC_RXD_1);
PINCTRL_MUX(MAC_RXD_2, 0, &PAD24_MAC_RXD_2);
PINCTRL_MUX(MAC_RXD_3, 0, &PAD25_MAC_RXD_3);
...
PINCTRL_MUX(MAC_TXD_2, 0, &PAD30_MAC_TXD_2);
PINCTRL_MUX(MAC_TXD_3, 0, &PAD31_MAC_TXD_3);
PINCTRL_MUX(MAC_TXEN, 0, &PAD32_MAC_TXEN);
PINCTRL_MUX(MAC_TXER, 0, &PAD34_MAC_TXER);

PINCTRL_MUX(PWM0, 0, &PAD19_PWM0, &PAD35_PWM0);
PINCTRL_MUX(PWM1, 0, &PAD36_PWM1, &PAD44_PWM1);
PINCTRL_MUX(PWM2, 0, &PAD37_PWM2, &PAD45_PWM2);
PINCTRL_MUX(PWM3, 0, &PAD38_PWM3, &PAD46_PWM3);
PINCTRL_MUX(PWM4, 0, &PAD20_PWM4, &PAD39_PWM4);
PINCTRL_MUX(PWM5, 0, &PAD17_PWM5, &PAD59_PWM5);
PINCTRL_MUX(PWM6, 0, &PAD18_PWM6, &PAD23_PWM6);
PINCTRL_MUX(PWM7, 0, &PAD21_PWM7, &PAD67_PWM7);
...
PINCTRL_MUX(SD1_WP, 1, &PAD33_SD1_WP, &PAD70_SD1_WP);
PINCTRL_MUX(SD1_DATA_0, 1, &PAD28_SD1_DATA_0, &PAD73_SD1_DATA_0);
PINCTRL_MUX(SD1_DATA_1, 1, &PAD29_SD1_DATA_1, &PAD74_SD1_DATA_1);
PINCTRL_MUX(SD1_DATA_2, 1, &PAD22_SD1_DATA_2, &PAD75_SD1_DATA_2);
PINCTRL_MUX(SD1_DATA_3, 1, &PAD23_SD1_DATA_3, &PAD76_SD1_DATA_3);
...
PINCTRL_MUX(SSI1_CLK, 0, &PAD37_SSI1_CLK, &PAD42_SSI1_CLK);
PINCTRL_MUX(SSI1_RXD, 0, &PAD36_SSI1_RXD, &PAD41_SSI1_RXD);
PINCTRL_MUX(SSI1_TXD, 0, &PAD35_SSI1_TXD, &PAD40_SSI1_TXD);
PINCTRL_MUX(SSI1_CSN_0, 0, &PAD38_SSI1_CSN_0, &PAD43_SSI1_CSN_0);
PINCTRL_MUX(SSI1_CSN_1, 0, &PAD39_SSI1_CSN_1, &PAD44_SSI1_CSN_1);
...
PINCTRL_MUX(UART1_RX, 0, &PAD20_UART1_RX, &PAD23_UART1_RX);
PINCTRL_MUX(UART1_TX, 0, &PAD19_UART1_TX, &PAD22_UART1_TX);
PINCTRL_MUX(UART2_RX, 0, &PAD17_UART2_RX, &PAD33_UART2_RX, &PAD46_UART2_RX);
PINCTRL_MUX(UART2_TX, 0, &PAD18_UART2_TX, &PAD26_UART2_TX, &PAD45_UART2_TX);
...
PINCTRL_MUX(GPIO17, 0, &PAD0_GPIO17);
PINCTRL_MUX(GPIO18, 0, &PAD1_GPIO18);
PINCTRL_MUX(GPIO19, 0, &PAD2_GPIO19);
PINCTRL_MUX(GPIO20, 0, &PAD3_GPIO20);
PINCTRL_MUX(GPIO21, 0, &PAD4_GPIO21);
PINCTRL_MUX(GPIO22, 0, &PAD5_GPIO22);
PINCTRL_MUX(GPIO23, 0, &PAD6_GPIO23);
PINCTRL_MUX(GPIO24, 0, &PAD7_GPIO24);
PINCTRL_MUX(GPIO25, 0, &PAD8_GPIO25);
PINCTRL_MUX(GPIO26, 0, &PAD9_GPIO26);
PINCTRL_MUX(GPIO27, 0, &PAD10_GPIO27);
PINCTRL_MUX(GPIO28, 0, &PAD11_GPIO28);
PINCTRL_MUX(GPIO29, 0, &PAD12_GPIO29);
PINCTRL_MUX(GPIO30, 0, &PAD13_GPIO30);
PINCTRL_MUX(GPIO31, 0, &PAD14_GPIO31);
PINCTRL_MUX(GPIO32, 0, &PAD19_GPIO32);
PINCTRL_MUX(GPIO33, 0, &PAD20_GPIO33);
PINCTRL_MUX(GPIO34, 0, &PAD17_GPIO34);
PINCTRL_MUX(GPIO35, 0, &PAD18_GPIO35);
PINCTRL_MUX(GPIO36, 0, &PAD21_GPIO36);
PINCTRL_MUX(GPIO37, 0, &PAD24_GPIO37);
PINCTRL_MUX(GPIO38, 0, &PAD25_GPIO38);
PINCTRL_MUX(GPIO39, 0, &PAD26_GPIO39);
PINCTRL_MUX(GPIO40, 0, &PAD33_GPIO40);
PINCTRL_MUX(GPIO41, 0, &PAD27_GPIO41);
PINCTRL_MUX(GPIO42, 0, &PAD30_GPIO42);
PINCTRL_MUX(GPIO43, 0, &PAD31_GPIO43);
PINCTRL_MUX(GPIO44, 0, &PAD32_GPIO44);
PINCTRL_MUX(GPIO45, 0, &PAD34_GPIO45);
...
PINCTRL_MUX(GPIO57, 0, &PAD74_GPIO57);
PINCTRL_MUX(GPIO58, 0, &PAD75_GPIO58);
PINCTRL_MUX(GPIO59, 0, &PAD76_GPIO59);
PINCTRL_MUX(GPIO60, 0, &PAD55_GPIO60);
PINCTRL_MUX(GPIO61, 0, &PAD54_GPIO61);
PINCTRL_MUX(GPIO62, 0, &PAD50_GPIO62);
PINCTRL_MUX(GPIO63, 0, &PAD51_GPIO63);
PINCTRL_MUX(GPIO64, 0, &PAD69_GPIO64);
PINCTRL_MUX(GPIO65, 0, &PAD70_GPIO65);
...
PINCTRL_DEVICE(CIS, 16, &MUX_CIS_CLK, &MUX_CIS_PCLK, &MUX_CIS_HSYNC,
        &MUX_CIS_VSYNC, &MUX_CIS_D_0, &MUX_CIS_D_1, &MUX_CIS_D_2, &MUX_CIS_D_3,
        &MUX_CIS_D_4, &MUX_CIS_D_5, &MUX_CIS_D_6, &MUX_CIS_D_7, &MUX_CIS_D_8,
        &MUX_CIS_D_9, &MUX_CIS_D_10, &MUX_CIS_D_11);
PINCTRL_DEVICE(I2C0, 2, &MUX_I2C0_SCL, &MUX_I2C0_SDA);
PINCTRL_DEVICE(I2C1, 2, &MUX_I2C1_SCL, &MUX_I2C1_SDA);
PINCTRL_DEVICE(MII, 20, &MUX_MAC_REF_CLK, &MUX_MAC_RMII_CLK, &MUX_MAC_COL,
        &MUX_MAC_CRS, &MUX_MAC_MDC, &MUX_MAC_MDIO, &MUX_MAC_RXCK, &MUX_MAC_RXD_0,
        &MUX_MAC_RXD_1, &MUX_MAC_RXD_2, &MUX_MAC_RXD_3, &MUX_MAC_RXDV, &MUX_MAC_RXER,
        &MUX_MAC_TXCK, &MUX_MAC_TXD_0, &MUX_MAC_TXD_1, &MUX_MAC_TXD_2, &MUX_MAC_TXD_3,
        &MUX_MAC_TXEN, &MUX_MAC_TXER);
...
char* fh_pinctrl_selected_devices[] =
{
    ...
    "GPIO9", "GPIO10", "GPIO11",
    "GPIO13", "GPIO14", "GPIO32", "GPIO33",
    "GPIO36", "GPIO37", "GPIO38", "GPIO41", "GPIO42",
    "GPIO43", "GPIO45",
    "GPIO60", "GPIO61"
};
